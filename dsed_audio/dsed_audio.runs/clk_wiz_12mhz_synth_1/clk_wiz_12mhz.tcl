...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir {C:/Users/carlo/Documents/Universidad/Cuarto curso/Primer Semestre/Diseo de sistemas electrnicos digitales/Proyecto final/Proyecto/dsed_audio/dsed_audio.runs/clk_wiz_12mhz_synth_1} -new_name clk_wiz_12mhz -ip [get_ips clk_wiz_12mhz]]

if { $cached_ip eq {} } {

synth_design -top clk_wiz_12mhz -part xc7a100tcsg324-1 -mode out_of_context
...
#---------------------------------------------------------
 ...
 config_ip_cache -add -dcp clk_wiz_12mhz.dcp -move_files $ipCachedFiles -use_project_ipc -ip [get_ips clk_wiz_12mhz]
}
