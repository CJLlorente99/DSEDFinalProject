...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot clk_wiz_12mhz xil_defaultlib.clk_wiz_12mhz -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim clk_wiz_12mhz -key {Behavioral:sim_1:Functional:clk_wiz_12mhz} -tclbatch cmd.tcl -log simulate.log
}
